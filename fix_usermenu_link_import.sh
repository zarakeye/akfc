#!/bin/bash
# Fix import Link manquant dans UserMenu (utilise <Link> sans l importer) —
# revele apres l ecrasement par fix_userdisplay_split. Ajoute l import.
# À lancer depuis la RACINE du monorepo : bash fix_usermenu_link_import.sh
set -euo pipefail
