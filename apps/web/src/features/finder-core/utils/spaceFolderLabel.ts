 ...
 *
 * Chemin d'un espace : `${appRoot}/collaborative-group-spaces|personal-space/<slug>-<cuid>` (cuid = id DB,
...
const SPACE_ROOT_PATH = /\/(collaborative-group-spaces|personal-space)\/[^/]+$/;
