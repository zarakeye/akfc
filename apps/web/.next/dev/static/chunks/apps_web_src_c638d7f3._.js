...
"[project]/apps/web/src/features/admin/perso/PersoPhotoUploader.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PersoPhotoUploader() {
    ...
    const quotaQuery = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$core$2f$trpc$2f$trpcClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["trpc"].storage.getPersoPhotoQuota.useQuery();
    const createAuthMutation = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$core$2f$trpc$2f$trpcClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["trpc"].storage.createUploadAuthorization.useMutation();
    const registerAssetMutation = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$core$2f$trpc$2f$trpcClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["trpc"].storage.registerUploadedAsset.useMutation();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$1_$40$babel$2b$core$40$7$2e$29$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0_sass$40$1$2e$100$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PersoPhotoUploader.useEffect": ()=>({
                "PersoPhotoUploader.useEffect": ()=>{
                    itemsRef.current.forEach({
                        "PersoPhotoUploader.useEffect": (it)=>URL.revokeObjectURL(it.previewUrl)
                    }["PersoPhotoUploader.useEffect"]);
                }
            })["PersoPhotoUploader.useEffect"]
    }["PersoPhotoUploader.useEffect"], []);
    ...
    /* ---- Ajout de fichiers (borné par le quota restant + limite de lot) ---- */ const onDrop = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$1_$40$babel$2b$core$40$7$2e$29$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0_sass$40$1$2e$100$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PersoPhotoUploader.useCallback[onDrop]": (accepted)=>{
            setItems({
                "PersoPhotoUploader.useCallback[onDrop]": (prev)=>{
                    const pendingNow = prev.filter({
                        "PersoPhotoUploader.useCallback[onDrop]": (it)=>it.status === 'pending'
                    }["PersoPhotoUploader.useCallback[onDrop]"]).length;
                    const slots = Math.min(Math.max(0, remaining - pendingNow), MAX_FILES_PER_BATCH - pendingNow);
                    const toAdd = accepted.slice(0, slots).map({
                        "PersoPhotoUploader.useCallback[onDrop].toAdd": (file)=>({
                                id: crypto.randomUUID(),
                                file,
                                previewUrl: URL.createObjectURL(file),
                                status: 'pending'
                            })
                    }["PersoPhotoUploader.useCallback[onDrop].toAdd"]);
            ...
            }["PersoPhotoUploader.useCallback[onDrop]"]);
        }
    }["PersoPhotoUploader.useCallback[onDrop]"], [
        remaining
    ]);
...
_s(PersoPhotoUploader, "axTA5Ru/zTWj6XmLY6LP5Ons8QE=", false, function() {
    return [
...
_c = PersoPhotoUploader;
var _c;
__turbopack_context__.k.register(_c, "PersoPhotoUploader");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/apps/web/src/app/(admin)/dashboard/mes-photos/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$1_$40$babel$2b$core$40$7$2e$29$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0_sass$40$1$2e$100$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/next@16.0.1_@babel+core@7.29.7_react-dom@19.2.0_react@19.2.0__react@19.2.0_sass@1.100.0/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$features$2f$admin$2f$perso$2f$PersoPhotoUploader$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/features/admin/perso/PersoPhotoUploader.tsx [app-client] (ecmascript)");
'use client';
;
;
...
_c = MesPhotosPage;
var _c;
__turbopack_context__.k.register(_c, "MesPhotosPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=apps_web_src_c638d7f3._.js.map