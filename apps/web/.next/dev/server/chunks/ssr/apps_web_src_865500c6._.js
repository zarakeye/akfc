...
"[project]/apps/web/src/lib/stores/useEventStore.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const useEventStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$zustand$40$5$2e$0$2e$14_$40$types$2b$react$40$19$2e$2$2e$15_react$40$19$2e$2$2e$0_use$2d$sync$2d$external$2d$store$40$1$2e$6$2e$0_react$40$19$2e$2$2e$0_$2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
   ...
   */ fetchEvents: async ()=>{
            const events = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$core$2f$trpc$2f$trpcClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["trpcClient"].event.getAll.query();
            set({
                events
            });
        },
   ...
   */ fetchEventsAdmin: async ()=>{
            const events = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$core$2f$trpc$2f$trpcClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["trpcClient"].event.getAllAdmin.query();
            set({
                events
            });
        },
   ...
   */ fetchEventById: async (id)=>{
            ...
            try {
                return await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$core$2f$trpc$2f$trpcClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["trpcClient"].event.getById.query({
                    id
                });
            } catch  {
                return null;
   ...
   */ createEvent: async (input)=>{
            const created = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$core$2f$trpc$2f$trpcClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["trpcClient"].event.create.mutate(input);
            set((state)=>({
                    events: [
                        ...state.events,
                        created
   ...
   */ updateEvent: async (input)=>{
            const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$core$2f$trpc$2f$trpcClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["trpcClient"].event.update.mutate(input);
            set((state)=>({
   ...
   */ deleteEvent: async (id)=>{
            await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$core$2f$trpc$2f$trpcClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["trpcClient"].event.delete.mutate({
                id
            });
            set((state)=>({
...
"[project]/apps/web/src/app/admin/dashboard/events/create/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$features$2f$admin$2f$events$2f$forms$2f$EventForm$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/features/admin/events/forms/EventForm.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$stores$2f$useEventStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/stores/useEventStore.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function CreateEventPage() {
    ...
    const createEvent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$stores$2f$useEventStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEventStore"])((s)=>s.createEvent);
...
//# sourceMappingURL=apps_web_src_865500c6._.js.map