...
"[project]/apps/web/src/lib/stores/useStageStore.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const useStageStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$zustand$40$5$2e$0$2e$14_$40$types$2b$react$40$19$2e$2$2e$15_react$40$19$2e$2$2e$0_use$2d$sync$2d$external$2d$store$40$1$2e$6$2e$0_react$40$19$2e$2$2e$0_$2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
   ...
   */ fetchStages: async ()=>{
            const stages = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$core$2f$trpc$2f$trpcClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["trpcClient"].stage.getAll.query();
            set({
                stages
            });
        },
   ...
   */ fetchStagesByDiscipline: async (disciplineId)=>{
            return await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$core$2f$trpc$2f$trpcClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["trpcClient"].stage.getAllByDiscipline.query({
                disciplineId
            });
        },
        /**
   ...
   */ fetchStageById: async (id)=>{
            ...
            try {
                return await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$core$2f$trpc$2f$trpcClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["trpcClient"].stage.getById.query({
                    id
                });
            } catch  {
                return null;
   ...
   */ createStage: async (input)=>{
            const created = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$core$2f$trpc$2f$trpcClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["trpcClient"].stage.create.mutate(input);
            set((state)=>({
                    stages: [
                        ...state.stages,
                        created
   ...
   */ updateStage: async (input)=>{
            const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$core$2f$trpc$2f$trpcClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["trpcClient"].stage.update.mutate(input);
            set((state)=>({
   ...
   */ deleteStage: async (id)=>{
            await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$core$2f$trpc$2f$trpcClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["trpcClient"].stage.delete.mutate({
                id
            });
            set((state)=>({
...
"[project]/apps/web/src/app/admin/dashboard/stages/create/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$features$2f$admin$2f$stages$2f$forms$2f$StageForm$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/features/admin/stages/forms/StageForm.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$stores$2f$useStageStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/stores/useStageStore.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function CreateStagePage() {
    ...
    const createStage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$stores$2f$useStageStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useStageStore"])((s)=>s.createStage);
...
//# sourceMappingURL=apps_web_src_fb34ca92._.js.map