...
"[project]/apps/web/src/lib/stores/usePostStore.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const usePostStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$zustand$40$5$2e$0$2e$14_$40$types$2b$react$40$19$2e$2$2e$15_react$40$19$2e$2$2e$0_use$2d$sync$2d$external$2d$store$40$1$2e$6$2e$0_react$40$19$2e$2$2e$0_$2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        ...
        fetchPosts: async ()=>{
            const posts = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$core$2f$trpc$2f$trpcClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["trpcClient"].post.getAll.query();
            set({
                posts
            });
        },
        fetchPostsAdmin: async ()=>{
            const posts = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$core$2f$trpc$2f$trpcClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["trpcClient"].post.getAllAdmin.query();
            set({
                posts
            });
        },
        fetchPostById: async (id)=>{
            ...
            try {
                return await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$core$2f$trpc$2f$trpcClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["trpcClient"].post.getById.query({
                    id
                });
            } catch  {
                return null;
        ...
        createPost: async (input)=>{
            const created = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$core$2f$trpc$2f$trpcClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["trpcClient"].post.create.mutate(input);
            set((state)=>({
                    posts: [
                        ...state.posts,
                        created
        ...
        updatePost: async (input)=>{
            const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$core$2f$trpc$2f$trpcClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["trpcClient"].post.update.mutate(input);
            set((state)=>({
        ...
        deletePost: async (id)=>{
            await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$core$2f$trpc$2f$trpcClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["trpcClient"].post.delete.mutate({
                id
            });
            set((state)=>({
...
"[project]/apps/web/src/app/admin/dashboard/posts/create/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$stores$2f$usePostStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/stores/usePostStore.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function CreatePostPage() {
    ...
    const createPost = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$stores$2f$usePostStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["usePostStore"])((s)=>s.createPost);
...
//# sourceMappingURL=apps_web_src_ba297a50._.js.map