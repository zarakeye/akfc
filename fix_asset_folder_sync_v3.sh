#!/bin/bash
# Fix DYNAMIC FOLDERS (v3, cast 'as unknown as') : renameAsset synchronise
# l'asset_folder en plus du public_id. Cause racine des fantomes / arbo
# divergente / picker.
# À lancer depuis la RACINE du monorepo : bash fix_asset_folder_sync_v3.sh
set -euo pipefail
