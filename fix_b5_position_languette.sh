#!/bin/bash
# Fix B.5 : panneau centre verticalement (ne couvre plus le carousel),
# languette neutre a coins arrondis + conges concaves a la jonction.
# À lancer depuis la RACINE du monorepo : bash fix_b5_position_languette.sh
set -euo pipefail
