#!/bin/bash
# Fix : dans le control panel (dashboard), le bouton "Mon profil" pointait
# vers /dashboard (home admin, sans bouton Editer) au lieu de /profil (page
# profil, qui a le bouton Editer). Corrige la cible.
# À lancer depuis la RACINE du monorepo : bash fix_controlpanel_profil_link.sh
set -euo pipefail
