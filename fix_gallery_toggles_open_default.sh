#!/bin/bash
# Vue galeries : toggles OUVERTS par defaut. Semantique inversee — on stocke
# les groupes REPLIES (Set vide = tout ouvert). Replier devient l acte de
# l utilisateur ; un groupe apparu apres filtrage est ouvert d office.
# À lancer depuis la RACINE du monorepo : bash fix_gallery_toggles_open_default.sh
set -euo pipefail
